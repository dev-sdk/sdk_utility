...
class UtilityRunApp {
  ...
  static Future<void> init({
    ...
    required void Function(BuildContext) materialContext,
    ...
    var runAppRef = UtilityRunApp._init(title, materialContext, routerConfig, initialProviders, enableAppLoader, key);
